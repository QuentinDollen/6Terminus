...
class Hud:
   ...
   def __init__(self, width, height):
        ...
        self.ingenieur = button_hud("View/Graphique/paneling_00167.png","View/Graphique/paneling_00168.png","View/Graphique/paneling_00169.png", (L1 , U4), size_button,Nume_ingenieur )
        self.santé = button_hud("View/Graphique/paneling_00163.png","View/Graphique/paneling_00164.png","View/Graphique/paneling_00165.png", ( L2 , U2) , size_button,Nume_sante)
        self.route = button_hud("View/Graphique/paneling_00135.png","View/Graphique/paneling_00136.png","View/Graphique/paneling_00137.png", (L3 , U1) ,size_button ,Nume_route)
        self.administratif = button_hud("View/Graphique/paneling_00139.png","View/Graphique/paneling_00140.png","View/Graphique/paneling_00141.png", (L3 , U3 ) , size_button ,Nume_administratif)
